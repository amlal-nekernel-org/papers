...
\begin{document}
	...
	\lettrine[lines=1, lhang=0.1, loversize=0.2]{W}hile an abrupt document, its purpose is for the development of methodology on using proof assistants for non-trivial conjectures and theorems of Mathematics.
