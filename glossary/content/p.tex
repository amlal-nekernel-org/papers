...
\lettrine[lines=2, lhang=0.1, loversize=0.2]{T}he glossary's purpose is to provide a reference for definitions, theorems, and equations for the purpose of being reusable.\\
...
The definitions spans from Mathematics to Information Theory. 
...
\lettrine[lines=2, lhang=0.1, loversize=0.2]{T}he nine pages of definitions now comes to an end, stating them here was the first step to then develop a framework later in the AWB.
